...
For linguists, that makes \emph{Rethinking Metaphysics} more than a case of exported theory. It shows why metaphysical uses of linguistic description are worth taking seriously. The lesson crosses subfields. Semanticists can ask what follows from reference, predication, or denotation; discourse theorists can ask what follows from packaging, anaphora, uptake, or theoretical elaboration. For phonologists and other specialists, the same question recurs: which projections does a description at that level license?

The local syntactic version is narrower. [\mention{The property of redness}], [\mention{the number of cups on the table}], and [\mention{the event of May's birth}] are ordinary NPs. Their NP status has syntactic consequences: they occur in NP positions, enter into NP-level dependencies, and bear functions available to NPs. It doesn't by itself support every expectation associated with familiar concrete-object nouns: perceptual tracking, causal explanation, theoretical indispensability, or metaphysical seriousness.

Neither dismissal nor conversion follows. Thomasson is right to reject a one-role model of language, and right that many metaphysical puzzles arise when a tracking model is projected across expressions with different roles. Her case also teaches linguistic theorists something: metaphysical disputes can show which projections follow from grammatical description and which have been imported from a familiar concrete-object noun model.
