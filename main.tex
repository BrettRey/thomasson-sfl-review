...
In the third sense, a discourse role is a pragmatic or teleological role in a practice. Thomasson has this sense in view when she asks what a stretch of discourse does for speakers, why it persists, and whether it should be retained, revised, or abandoned. It's also the sense that matters for conceptual engineering. A reverse-engineering project asks what an expression is good for before deciding whether it's philosophically suspect \citep[203--207]{thomasson2025rethink}. That role can be descriptive or normative: what the expression has done, what it now does, or what we'd endorse keeping it for.
