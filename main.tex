...
That last claim is about explanatory placement, not about whether SFL is useful. A grammar can help identify the expressions whose discourse roles matter, and it can describe the constructions that make those roles available. The rejected step isn't including those roles in the broader projectibility profile. It's treating them as what makes an expression a noun, a determinative, a subject, or a determiner.
