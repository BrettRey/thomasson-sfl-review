...
These roles may belong in the broader property cluster or projectibility profile associated with a construction, where the profile is the set of inferences the construction supports under specified conditions. The open question is whether those roles are category-making conditions for syntactic category or syntactic function. The roles are real; the placement is optional.
...
The caution is narrower: those results don't require the Hallidayan decision to put discourse roles inside grammatical architecture. They require a plural account of what linguistic expressions do, plus a grammar that keeps syntactic distribution, syntactic category, syntactic function, and discourse role in view without treating any one of them as a proxy for the others.
